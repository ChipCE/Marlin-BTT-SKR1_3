...
#define HOTEND_IDLE_TIMEOUT
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (10*60*60)    // (seconds) Time without extruder movement to trigger protection
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LED_CONTROL_MENU
    ...
    #define LED_COLOR_PRESETS                 // Enable the Preset Color menu option
      ...
      #define LED_USER_PRESET_GREEN      191  // User defined GREEN value
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_STOP "G28 R20 X\nG90\nG1 X0 Y215\nM84 X Y Z E"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
 ...
 */
  ...
  // Note: this values cannot be calibrated and have to be set manually
    ...
    #define PTC_PARK_POS   { -10, 105, 100 }

    // Probe position to probe and wait for probe to reach target temperature
    #define PTC_PROBE_POS  { 90, 105 }
