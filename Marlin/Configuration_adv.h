...
#define HOMING_BUMP_MM      { 2, 3, 5 }       // (mm) Backoff from endstops after first bump
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  17, 105 }, { 235,  105 } }
 ...
 */
  ...
  #define PROBING_MARGIN_LEFT 17 //PROBING_MARGIN
  #define PROBING_MARGIN_RIGHT 17 //PROBING_MARGIN
  #define PROBING_MARGIN_FRONT 20 //PROBING_MARGIN
  #define PROBING_MARGIN_BACK 33 //PROBING_MARGIN
#endif
